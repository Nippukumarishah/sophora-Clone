...
const Navbar = () => {
    ...
    const pro = JSON.parse(localStorage.getItem("user")) || "Login";
    ...
    <div className="NavbarContainer-1">
        ...
        <div className="Navbar-14" title={"Click me"}>
            ...
            <div className="Navbar-12">
                ...
                <input type="text" className="Navbar-13" placeholder='Search SEPHORA' />
            </div>
                ...
                <div className="Navbar-17">
                    ...
                    <Link to={`/login`} title={'Click to login'}>
                        <span id="adjustment1">
                            ...
                            <RiContactsLine /> <p style={{marginLeft:'5px',color:"rgb(255,51,153)"}}>{pro =="Login" ? pro : ''}</p>
                            </li>
                        </span>
                    </Link> : null}
                    <div className="hellohover" style={pro !== "Login" ? { color: "rgb(255,51,153)", cursor:"pointer"}:{color:"black"}}>
                        {pro=="Login" ? '' : pro}
                    </div>
                    {pro !== "Login" ? <p className='hellohover' onClick={() => lagout()} style={{color:"rgb(255,51,153)", cursor: "pointer"}}>Logout</p> : null}
                </div>
            </div>
        </div>
    </div>
